            ...
            <div class="container mx-auto py-3 px-4">
                <nav aria-label="breadcrumb">
                    <ol class="list-none p-0 inline-flex">
                        ...
                        <li aria-current="page">
                            <span class="text-gray-500">{{ $reportDetail->name .' '. $reportDetail->surname}}</span>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="container mx-auto my-5 px-4">
            ...
            <div class="border border-gray-200 rounded shadow-lg">
                <div class="rounded-t text-left font-regular text-xl bg-gray-600 text-white px-4 py-2">
                    {{ $reportDetail->name .' '. $reportDetail->surname}}
                </div>
                <div class="bg-gray-100">
                    <ul>
                        <li class="mb-2 bg-white py-3 px-4"><span class="font-regular">Telefon Numarası:</span> {{ $reportDetail->phone }}</li>
                        <li class="mb-2 bg-white py-3 px-4"><span class="font-regular">E-Posta Adresi:</span> {{ $reportDetail->email }}</li>
                        <li class="mb-2 bg-white py-3 px-4"><span class="font-regular">İletişim Tercihi:</span> {{ str_replace(['phone', 'email'], ['Telefon ile dönüş yapılsın', 'E-Posta ile dönüş yapılsın'], $reportDetail->contactType ) }}</li>
                        <li class="mb-2 bg-white py-3 px-4"><span class="font-regular">I.P. Adresi:</span> {{ $reportDetail->ip }}</li>
